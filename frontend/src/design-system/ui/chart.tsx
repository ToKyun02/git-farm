...
function ChartTooltipContent({
    ...
    active?: boolean;
    payload?: Array<{ name?: string; dataKey?: string; color?: string; value?: unknown; payload?: Record<string, unknown> }>;
    label?: string;
    ...
    return (
        <div className={cn('border-border/50 bg-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl', className)}>
            ...
            <div className='grid gap-1.5'>
                {payload.map((item: { name?: string; dataKey?: string; color?: string; value?: unknown; payload?: Record<string, unknown> }, index: number) => {
...
function ChartLegendContent({
    ...
    payload?: Array<{ value?: unknown; dataKey?: string; color?: string; type?: string }>;
    ...
    return (
        <div className={cn('flex items-center justify-center gap-4', verticalAlign === 'top' ? 'pb-3' : 'pt-3', className)}>
            {payload.map((item: { value?: unknown; dataKey?: string; color?: string; type?: string }) => {
